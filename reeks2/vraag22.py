...
# - als het element op index i gelijk is aan het element op index i+1, dan worden deze twee elementen samengevoegd
#   tot één element dat gelijk is aan de som van de twee elementen (of het dubbel van een van de twee).
#   Het element op index i+1 wordt dan 0.
# - als het element op index i niet gelijk is aan 0 en niet gelijk is aan het element op index i+1, gebeurt er niets.
